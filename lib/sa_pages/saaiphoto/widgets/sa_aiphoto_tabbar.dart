...
/// hello
class SAAIPhotoTabbar extends GetView<SaaiphotoController> {
  const SAAIPhotoTabbar({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Expanded(
          child: TabBarView(controller: controller.tabController, children: controller.tabViews),
        ),
      ],
    );
  }
