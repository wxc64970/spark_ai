...
import 'package:spark_ai/sa_pages/saChat/index.dart';
...
import 'sa_c_list_widget.dart';
import 'sa_f_widget.dart';
import 'sa_k_a_widget.dart';

class SAChatTabbar extends GetView<SachatController> {
  const SAChatTabbar({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Expanded(
          child: TabBarView(
            controller: controller.tabController,
            children: [
              KeepAliveWrapper(child: ConversationListWidget(controller: chatCtr)),
