...
class SARicTItem extends StatelessWidget {
  const SARicTItem({
    super.key,
    required this.text,
  ...
  Widget build(BuildContext context) {
    final nomarlStyel = TextStyle(color: Colors.white, fontSize: 28.sp, fontWeight: FontWeight.w400, height: 1.5);

    final highlightSetyle = TextStyle(color: Colors.white, fontSize: 28.sp, fontWeight: FontWeight.bold, height: 1.5, fontStyle: FontStyle.italic);
