...
class SATypTItem extends StatelessWidget {
  const SATypTItem({
    super.key,
    required this.text,
  ...
  Widget build(BuildContext context) {
    final nomarlStyel = TextStyle(color: Color(0xff222222), fontSize: 28.sp, fontWeight: FontWeight.w500, height: 1.4);

    const highlightSetyle = TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold, height: 1.4, fontStyle: FontStyle.italic);
