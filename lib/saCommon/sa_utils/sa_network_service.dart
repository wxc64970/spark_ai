...
/// 全局网络监听服务
class SANetworkMonitorService extends GetxService {
  static SANetworkMonitorService get to => Get.find();
  ...
  /// 在有网络时执行操作
  Future<T?> executeWithNetworkCheck<T>({required Future<T> Function() onConnected, Function()? onDisconnected}) async {
    if (isConnected) {
