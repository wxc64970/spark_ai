...
class SARichTextPlaceholder extends StatelessWidget {
  final String textKey;
  final Map<String, InlineSpan> placeholders;
  final TextStyle? style;

  const SARichTextPlaceholder({super.key, required this.textKey, this.placeholders = const {}, this.style});
  ...
  TextSpan _parse(String input) {
    ...
    for (final match in regex.allMatches(input)) {
      ...
      if (start > currentIndex) {
        spans.add(TextSpan(text: input.substring(currentIndex, start), style: style));
      }
