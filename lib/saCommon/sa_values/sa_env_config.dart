...
class EnvConfig {
  static SAEnv _currentEnv = SAEnv.prod;

  static Future<void> initialize(SAEnv env) async {
    _currentEnv = env;
  ...
  static String get bundleId => Platform.isIOS ? dotenv.get('BUNDLE_ID_IOS') : dotenv.get('BUNDLE_ID_ANDROID');

  static String get platform => Platform.isIOS ? dotenv.get('PLATFORM_IOS') : dotenv.get('PLATFORM_ANDROID');
  ...
  static SAEnv get currentEnv => _currentEnv;
}
